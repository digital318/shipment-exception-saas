-- =============================================================================
-- FreightPulse — Phase 7C: customer_notifications
-- =============================================================================
-- Run in Supabase SQL Editor after prior migrations (004b+).
-- Standalone copy: supabase/customer_notifications.sql
-- =============================================================================
...
COMMENT ON COLUMN public.customer_notifications.type IS
  'shipment_delayed | shipment_exception | shipment_delivered | exception_updated | exception_resolved | sla_risk_warning';

COMMENT ON COLUMN public.customer_notifications.status IS
  'Unread or Read';
